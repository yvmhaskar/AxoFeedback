...
*/
// constants
unsigned float triggerPercent{0.37};
static constexpr int maxAngle{800};
static constexpr float motorOnPercent{0.3};
static constexpr int zeroAngle{0};

void bangBangAtPushoff(Axo& axo, unsigned long timeSinceLastHeelStrike, unsigned long lastStepTime, unsigned long triggerPercent) {
